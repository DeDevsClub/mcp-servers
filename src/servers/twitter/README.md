# twitter-mpc
Contains and hosts the Twitter MPC that is used throughout DeDevs.

# Twitter MCP Server

<!-- [![smithery badge](https://smithery.ai/badge/@dedevsclub/twitter-mcp)](https://smithery.ai/server/@dedevsclub/twitter-mcp) -->
...
```bash
git clone https://github.com/DeDevsClub/twitter-mcp.git
cd twitter-mcp
```
